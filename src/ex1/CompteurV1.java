 ...
 * @author Maxime
 */
public class CompteurV1 extends Thread {
     ...
     * @param n nombre
     */
    public CompteurV1(String nom, int n) {
        this.nom = nom;
        this.n = n;
    }
    ...
    public static void main(String[] args) {
        ...
        Thread t1 = new CompteurV1("toto", 15);
        Thread t2 = new CompteurV1("titi", 15);
        Thread t3 = new CompteurV1("tata", 15);
